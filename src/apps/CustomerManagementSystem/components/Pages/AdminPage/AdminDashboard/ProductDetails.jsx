...
import {
  ...
  reduceImagesResolution,
} from "./Warehouse&Cities.js/functionForImageResulation";
...
function ProductDetails() {
  ...
  const [isInstructionImgModalOpen, setIsInstructionImgModalOpen] =
    useState(false);
  const [isInstructionVideoModalOpen, setIsInstructionVideoModalOpen] =
    useState(false);
  ...
  const handleEditDescriptionSubmit = async (productId) => {
    ...
    try {
      const response = await axios.put(
        `https://grozziieget.zjweiting.com:8033/tht/${
          Product?.imgPath.split("/")[4]
        }/updateDescriptionImage/${productId}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleEditInstructionVideoSubmit = async (productId) => {
    ...
    try {
      const response = await axios.put(
        `https://grozziieget.zjweiting.com:8033/tht/${
          Product?.imgPath.split("/")[4]
        }/updateInstructionVideos/${productId}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleEditInstructionImgSubmit = async (productId) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://grozziieget.zjweiting.com:8033/tht/${
          Product?.imgPath.split("/")[4]
        }/updateInstructionsImages/${productId}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  return (
    <div className="text-gray-800">
          ...
          <div className="flex flex-col md:flex-row md:space-x-4">
            <div>
              <div className="flex justify-center relative">
                <div
                  title={`Link:  ${Product?.productImgLink}\nRemark:  ${Product?.productImgRemark}`}
                  className="md:w-1/2 mb-4 "
                >
                  <img
                    src={`https://grozziieget.zjweiting.com:8033/tht/${
                ...
                <button
                  className="text-blue-500 absolute right-16 font-bold text-3xl cursor-pointer"
                  onClick={openModal}
                >
                  <FiEdit></FiEdit>
                </button>
                  ...
                  <div className="fixed z-50 inset-0 grid grid-cols-2 mx-auto rounded-lg h-[900px] w-5/6 my-auto bg-white bg-opacity-100 border-2 shadow-xl">
                    <div className="bg-white w-11/12 my-4 mx-auto p-2 px-8 text-center rounded-lg shadow-xl">
                      ...
                      <div>
                        <div className="mb-2 grid  grid-cols-3 text-start">
                          <label
                            htmlFor="modelNumber"
                            className="block col-span-1 text-gray-700 font-semibold mb-2"
                          >
                            Img Link
                          </label>
                          <input
                    ...
                    <div className="w-full pt-10 px-8">
                      ...
                      <div className="mb-2 grid  grid-cols-3 text-start ">
                        <label
                          htmlFor="modelNumber"
                          className="block col-span-1 text-gray-700 font-bold mb-2"
                        >
                          Stock Quantity
                        </label>
                        <input
                      ...
                      <div className="mb-1 grid  grid-cols-3 text-start">
                        <label
                          htmlFor="relatedImgLink"
                          className="block col-span-1 text-gray-500 font-semibold mb-1"
                        >
                          Related Imgs Link
                        </label>
                        <input
                      ...
                      <div className="mb-1">
                        <label
                          htmlFor="productImageRemark"
                          className="block text-start text-gray-700 font-bold mb-1"
                        >
                      ...
                      <div className="mb-1">
                        <label
                          htmlFor="afterSales"
                          className="block text-gray-700 font-bold mb-1 text-start"
                        >
                          After-Sales
                        </label>
                        <textarea
                      ...
                      <div className="mb-1">
                        <label
                          htmlFor="afterSalesInstructions"
                          className="block text-start text-gray-700 font-bold mb-1"
                        >
              ...
              <AddColorImg Product={Product}></AddColorImg>
            </div>
            ...
            <div className="md:w-1/2 text-start pl-5 relative">
              ...
              <button
                className="text-blue-500 absolute right-0 font-bold text-3xl cursor-pointer"
              ...
              <div className="flex space-x-4 text-gray-500">
                <div className="flex-grow border pl-3 mr-8 rounded-md">
                  <p className="text-gray-700">
                    {Product?.shelfStartTime?.split("T")[0]}
                  </p>
                </div>
                <div className="flex-grow border pl-3 mr-8 rounded-md">
                  <p className="text-gray-700">
                    {Product?.shelfEndTime?.split("T")[0]}
                  </p>
                </div>
              </div>
                  ...
                  <div className="fixed z-50 inset-0  mx-auto rounded-lg h-1/3 w-1/3 my-auto bg-gray-900 bg-opacity-50">
                    <div className="bg-white w-11/12 my-4 mx-auto p-2 px-8 text-center rounded-lg">
                      ...
                      <div className="mt-8 text-right">
                        <button
                          onClick={() =>
                            handleEditDescriptionSubmit(Product?.id)
                          }
                          className="bg-blue-500 text-white  py-2 rounded-md mr-5 px-16 font-bold"
                        >
                          Save
              ...
              <div className="container relative">
                ...
                {Product && (
                  <div
                    title={`Link: ${Product?.relatedImgLink}\nRemark: ${Product?.relatedImgRemark}`}
                  ...
                  <div className="fixed z-50 inset-0  mx-auto rounded-lg h-1/3 w-1/3 my-auto bg-gray-900 bg-opacity-50">
                    <div className="bg-white w-11/12 my-4 mx-auto p-2 px-8 text-center rounded-lg">
                      ...
                      <div className="mt-8 text-right">
                        <button
                          onClick={() =>
                            handleEditRelatedVideoSubmit(Product?.id)
                          }
                          className="bg-blue-500 text-white  py-2 rounded-md mr-5 px-16 font-bold"
                        >
                          Save
              ...
              <div className="container relative">
                ...
                <button
                  className="text-blue-500 absolute right-0 font-bold text-3xl cursor-pointer"
                  onClick={openInstructionImgModal}
                >
                  <FiEdit></FiEdit>
                </button>
                ...
                {isInstructionImgModalOpen && (
                  <div className="fixed z-50 inset-0  mx-auto rounded-lg h-1/3 w-1/3 my-auto bg-gray-900 bg-opacity-50">
                    <div className="bg-white w-11/12 my-4 mx-auto p-2 px-8 text-center rounded-lg">
                      <h2 className="text-lg font-bold mb-2">
                        Edit Instruction Images{" "}
                      </h2>
                      <input
                        type="file"
                        onChange={handleInstructionImgUpload}
                        multiple
                        className="bg-[#004368] hover:bg-blue-700 text-white font-bold py-2 my-2 px-3 lg:px-2 lg:ml-5 rounded-lg "
                        accept="image/*"
                      />
                      ...
                      <div className="mt-8 text-right">
                        <button
                          onClick={() =>
                            handleEditInstructionImgSubmit(Product?.id)
                          }
                          className="bg-blue-500 text-white  py-2 rounded-md mr-5 px-16 font-bold"
                        >
                          Save
              ...
              <div className="container">
                ...
                <button
                  className="text-blue-500 absolute right-0 font-bold text-3xl cursor-pointer"
                  onClick={openInstructionVideoModal}
                >
                  <FiEdit></FiEdit>
                </button>
                ...
                {isInstructionVideoModalOpen && (
                  <div className="fixed z-50 inset-0  mx-auto rounded-lg h-1/3 w-1/3 my-auto bg-gray-900 bg-opacity-50">
                    <div className="bg-white w-11/12 my-4 mx-auto p-2 px-8 text-center rounded-lg">
                      <h2 className="text-lg font-bold mb-2">
                        Edit Instruction Videos{" "}
                      </h2>
                      <input
                        type="file"
                        onChange={handleInstructionVideoUpload}
                        multiple
                        className="bg-[#004368] hover:bg-blue-700 text-white font-bold py-2 my-2 px-3 lg:px-2 lg:ml-5 rounded-lg "
                        accept="video/*"
                      />
                      ...
                      <div className="mt-8 text-right">
                        <button
                          onClick={() =>
                            handleEditInstructionVideoSubmit(Product?.id)
                          }
                          className="bg-blue-500 text-white  py-2 rounded-md mr-5 px-16 font-bold"
                        >
                          Save
      ...
      <ProductDetailsLayout product={Product}></ProductDetailsLayout>
    </div>
  );
}
