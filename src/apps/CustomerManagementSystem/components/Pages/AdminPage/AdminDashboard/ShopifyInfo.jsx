  ...
  const handleSave = async () => {
    ...
    try {
      const response = await axios.put(
        "https://grozziieget.zjweiting.com:8033/tht/mallProducts/ShopifyLinkMark/update/1",
        {
          ...
          {shopifyData && (
            <section className="mt-12 bg-gray-100 p-6">
              ...
              <div className="text-gray-700">
                <p>
                  <strong>Mark:</strong> {shopifyData.mark}
                </p>
                <p>
                  <strong>Link:</strong>{" "}
                  <a
