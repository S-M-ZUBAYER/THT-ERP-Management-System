...
const VersionInfo = () => {
  ...
  const handleTestAppSave = async () => {
    ...
    if (
      !testDownloadUrl ||
      !/^https?:\/\/[^\s$.?#].[^\s]*$/.test(testDownloadUrl)
    ) {
    ...
    try {
      ...
      const response = await axios.put(
        `https://grozziieget.zjweiting.com:8033/tht/testVersion/update/${testAndroidId}`,
        {
  ...
  const handleAppSave = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://grozziieget.zjweiting.com:8033/tht/version/update/${androidId}`,
        {
          appVersion,
          releaseNotes,
          downloadUrl,
  ...
  const handleIosSave = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://grozziieget.zjweiting.com:8033/tht/version/update/${iosId}`,
        {
  ...
  const handleChineseAppSave = async () => {
    ...
    if (
      !chineseDownloadUrl ||
      !/^https?:\/\/[^\s$.?#].[^\s]*$/.test(chineseDownloadUrl)
    ) {
    ...
    try {
      // const response = await axios.put(`http://localhost:2000/tht/version/update/${androidId}`, {
      const response = await axios.put(
        `https://jiapuv.com:8033/tht/version/update/${chineseAndroidId}`,
        {
  ...
  const handleChineseIosSave = async () => {
    ...
    if (
      !chineseIosDownloadUrl ||
      !/^https?:\/\/[^\s$.?#].[^\s]*$/.test(chineseIosDownloadUrl)
    ) {
      toast.error("Please enter a valid URL for the chinese download link");
      return;
    }
    ...
    try {
      // const response = await axios.put(`http://localhost:2000/tht/version/update/${iosId}`, {
      const response = await axios.put(
        `https://jiapuv.com:8033/tht/version/update/${chineseIosId}`,
        {
  ...
  return (
    <div>
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <div className="p-8 max-w-2xl w-full mx-auto bg-gray-50">
          ...
          <section className="mb-8">
            <label className="block font-medium text-gray-700 text-lg mb-2">
              Android App Version
            </label>
            <input
              type="text"
          ...
          <div className="flex justify-between mt-8">
            ...
            <button
              ...
              className={`px-6 py-3 font-medium text-white rounded transition-colors ${
                loading ? "bg-gray-400" : "bg-[#004368]  hover:bg-blue-700"
              }`}
              disabled={loading}
            >
              {loading ? "Saving..." : "Save"}
          ...
          {appData && (
            <section className="mt-12 bg-gray-100 p-6">
              <h3 className="text-2xl font-medium text-gray-800 mb-4">
                Current Android Application Data
              </h3>
              <div className="text-gray-700">
                <p>
                  <strong>Android App Version:</strong> {appData.appVersion}
                </p>
                <p>
                  <strong>Android Release Notes:</strong> {appData.releaseNotes}
                </p>
                <p>
                  <strong>Android Download URL:</strong>{" "}
                  <a
                    href={appData.downloadUrl}
                    target="_blank"
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 pt-32">
        <div className="p-8 max-w-2xl w-full mx-auto bg-gray-50">
          ...
          {iosAppData && (
            <section className="mt-12 bg-gray-100 p-6">
              <h3 className="text-2xl font-medium text-gray-800 mb-4">
                Current Ios Application Data
              </h3>
              <div className="text-gray-700">
                <p>
                  <strong>Ios App Version:</strong> {iosAppData.appVersion}
                </p>
                <p>
                  <strong>Ios Release Notes:</strong> {iosAppData.releaseNotes}
                </p>
                <p>
                  <strong>Ios Download URL:</strong>{" "}
                  <a
                    href={iosAppData.downloadUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 underline"
                  >
                    {iosAppData.downloadUrl}
                  </a>
                </p>
              </div>
            </section>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 pt-32">
        <div className="p-8 max-w-2xl w-full mx-auto bg-gray-50">
          ...
          {chineseAppData && (
            <section className="mt-12 bg-gray-100 p-6">
              <h3 className="text-2xl font-medium text-gray-800 mb-4">
                Current Chinese Android Application Data
              </h3>
              <div className="text-gray-700">
                <p>
                  <strong>Chinese Android App Version:</strong>{" "}
                  {chineseAppData.appVersion}
                </p>
                <p>
                  <strong>Chinese Android Release Notes:</strong>{" "}
                  {chineseAppData.releaseNotes}
                </p>
                <p>
                  <strong>Chinese Android Download URL:</strong>{" "}
                  <a
                    href={chineseAppData.downloadUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 underline"
                  >
                    {chineseAppData.downloadUrl}
                  </a>
                </p>
              </div>
            </section>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 pt-32">
        <div className="p-8 max-w-2xl w-full mx-auto bg-gray-50">
          ...
          {chineseIosAppData && (
            <section className="mt-12 bg-gray-100 p-6">
              <h3 className="text-2xl font-medium text-gray-800 mb-4">
                Current Chinese Ios Application Data
              </h3>
              <div className="text-gray-700">
                <p>
                  <strong>Chinese Ios App Version:</strong>{" "}
                  {chineseIosAppData.appVersion}
                </p>
                <p>
                  <strong>Chinese Ios Release Notes:</strong>{" "}
                  {chineseIosAppData.releaseNotes}
                </p>
                <p>
                  <strong>Chinese Ios Download URL:</strong>{" "}
                  <a
                    href={chineseIosAppData.downloadUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 underline"
                  >
                    {chineseIosAppData.downloadUrl}
                  </a>
                </p>
              </div>
            </section>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 pt-32">
        <div className="p-8 max-w-2xl w-full mx-auto bg-gray-50">
          <h2 className="text-3xl font-semibold text-gray-800 mb-6 text-center">
            <strong className="text-red-600">Test</strong> Global Android
            Application Information
          </h2>

          <section className="mb-8">
            <label className="block font-medium text-gray-700 text-lg mb-2">
              Test Android App Version
            </label>
            <input
              type="text"
          ...
          {appTestData && (
            <section className="mt-12 bg-gray-100 p-6">
              <h3 className="text-2xl font-medium text-gray-800 mb-4">
                Current Test Android Application Data
              </h3>
              <div className="text-gray-700">
                <p>
                  <strong>Test Android App Version:</strong>{" "}
                  {appTestData?.appVersion}
                </p>
                <p>
                  <strong>Test Android Release Notes:</strong>{" "}
                  {appTestData?.releaseNotes}
                </p>
                <p>
                  <strong>Test Android Download URL:</strong>{" "}
                  <a
                    href={appTestData?.downloadUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 underline"
                  >
                    {appTestData?.downloadUrl}
                  </a>
                </p>
              </div>
            </section>
