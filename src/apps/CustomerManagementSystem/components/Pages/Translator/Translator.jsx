...
function Translator() {
  ...
  return (
    <div>
      <h1 className="font-bold text-2xl underline  text-yellow-600">
        Single language Translator System
      </h1>

      <div className="App md:my-24 flex justify-center items-center bg-yellow-300">
        <ToastContainer />
        <div className=" ">
      ...
      <div className="App md:my-24 flex justify-center items-center bg-lime-300">
        <ToastContainer />
        <div className=" ">
          {/* <h1 className="text-3xl font-bold mb-10 mt-10 md:mt-0">ZUSS Translator</h1> */}
