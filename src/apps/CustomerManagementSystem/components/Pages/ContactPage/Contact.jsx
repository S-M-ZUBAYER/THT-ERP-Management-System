    ...
    <div className="w-full">
        ...
        <div className="relative mx-auto  px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
          <div className="text-center sm:text-left">
            ...
            <p className="mt-4 max-w-lg sm:text-xl text-cyan-800 sm:leading-relaxed">
              Welcome to our THT-Space Electrical Company Ltd to see and check
              the product and any further reason...
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="mt-20">
        ...
        <p className=" text-gray-600">
          If you need to get in touch with us, there are several ways to do so.
          You can reach out to us via email, phone, or through our website's
          contact form.
        </p>
          ...
          <div className=" md:text-start  md:ml-28 my-auto mx-auto">
            ...
            <div className="my-5">
              ...
              <div className="text-gray-600">
                <p className="mb-1">+000 12345 6789</p>
                <p className="mb-1">+000 12345 6789</p>
                <p className="mb-1">+000 12345 6789</p>
              </div>
            </div>
            ...
            <div className="my-5">
              ...
              <p className="text-gray-600">smzubayer9004@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="w-5/6 md:w-4/6 lg:w-full mx-auto">
          <h1 className="text-xl font-semibold text-black capitalize  lg:text-3xl">
            Let’s get in touch
          </h1>

          <p className="mt-4 text-gray-600  ">
            If you need to get in touch with us, there are several ways to do
            so. You can reach out to us via email, phone, or through our
