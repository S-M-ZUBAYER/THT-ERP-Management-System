...
const AddCFLevel = () => {
  ...
  return (
    <div className="max-w-[1000mx] mx-auto p-6 bg-white rounded-lg ">
      <h1 className="text-4xl font-bold text-cyan-600 text-center my-5">
        ...
        <button
          ...
          className={`px-10 py-2 rounded text-white ${
            adding
              ...
              : "btn btn-info px-10 active:scale-[.98] active:duration-75 hover:scale-[1.03] ease-in-out transition-all py-3 rounded-lg bg-violet-500 text-white font-bold hover:text-black"
          }`}
        >
          {adding ? "Adding..." : "Add"}
        </button>
      ...
      <div className="mt-6">
        <h2 className="text-center my-6 text-2xl text-info font-bold bg-slate-500 p-[10px] rounded-lg uppercase text-[#93E6FB] ">
          Existing C&F Commission Levels
        </h2>
        {loading ? (
          <div className="">
            <ClipLoader
            ...
            <table className="min-w-full bg-white border border-gray-200">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className=" py-2 px-4 border-b font-medium text-gray-600 text-center">
                    Actions
                  </th>
                </tr>
              </thead>
