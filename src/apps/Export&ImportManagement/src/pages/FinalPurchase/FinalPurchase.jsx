...
const FinalPurchase = () => {
  ...
  const handleSave = () => {
    const confirmSave = window.confirm(
      "Do you want to Save this data to check finance?"
    );
    if (confirmSave) {
      setSelectedPurchase((prevState) => {
      ...
      axios
        ...
        .then((response) => {
          ...
          const purchaseList = purchases.filter(
  ...
  const handleSearchChange = (e) => {
    ...
    const filteredProducts = purchases.filter(
      (account) =>
    ...
    <div className="container mx-auto px-4">
      <div className="">
        ...
        <p className="text-red-600 text-sm text-center font-medium">
          ** Please Fillup this form carefully & check all fields. You can't
          modify it later. **
        </p>
